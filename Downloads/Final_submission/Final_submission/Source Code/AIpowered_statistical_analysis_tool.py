...
if not os.path.exists("app_lock.txt"):
    with open("app_lock.txt", "w") as f:
        f.write("launched")
    subprocess.run(["streamlit", "run", "AIpowered_statistical_analysis_tool.py"])
...
if os.path.exists(req_file):
    try:
        ...
        print("⚠️ Failed to install dependencies from requirements.txt")
...
# 🖥️ Streamlit Page Configuration and App Title
...
# 📤 File Upload and Tab Configuration
